...
public enum TemplateTypes {
    ...
    ProjectsIn("Property In", THandlerProjectIn.class), UpcomingProjectsIn("Upcoming Property In",
            THandlerProjectIn.class), NewProjectsIn("New Property In", THandlerProjectIn.class), PreLaunchProjectsIn(
            "Pre Launch Property In", THandlerProjectIn.class), UnderConstProjectsIn("Under Construction Property In",
            THandlerProjectIn.class), ReadyToMoveProjectsIn("Ready to move Property In", THandlerProjectIn.class), AffordableProjectsIn(
            "Affordable Property In", THandlerProjectIn.class), LuxuryProjectsIn("Luxury Property In",
            THandlerProjectIn.class), TopProjectsIn("Top Property In", THandlerProjectIn.class),

    PropertyBy("Property by", THandlerProjectsBy.class), PropertyForSaleIn("Property for sale in",
            THandlerPropertyFor.class), PropertyForResaleIn("Property for resale in", THandlerPropertyFor.class),
