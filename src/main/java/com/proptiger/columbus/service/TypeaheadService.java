...
public class TypeaheadService {
    ...
    public List<Typeahead> getTypeaheadsV3(
        ...
        Collections.sort(results, new TypeaheadUtils.TypeaheadComparatorScore());
    ...
    private List<Typeahead> sortAndRemoveDuplicates(List<Typeahead> resultsOriginal) {
        Collections.sort(resultsOriginal, new TypeaheadUtils.TypeaheadComparatorScore());
        ...
        List<Typeahead> resultsFinal = UtilityClass.getMergedListRemoveDuplicates(
                listOfresults,
                new TypeaheadUtils.TypeaheadComparatorId());
