...
INSERT INTO cms.`resi_project` VALUES (0,last_insert_id(),'Website',100850,52190,'Surakshaa Habitat','After the success of Surakshaa Hills and Surakshaa Enclave, Surakshaa set forth in motion its third residential colony venture named the Surakshaa Habitat. The colony is located in the Ameenpur village in Patancheru, Mandal and is completely Panchayat approved, built in accordance with HUDA norms. The SURAKSHAA HABITAT is spread over 5 acres of land, consisting of 78 Plots, 40&prime; feet Main Roads and 30&prime; wide lanes, with conveniently designed layout and modern facilities.','Ameenpur village, Patancheru, Hyderabad.','/surakshaa-homes/surakshaa-habitat/land-plots-small.jpg',1.00000000,1.00000000,999,'Active',3,concat('hyderabad/patancheru/surakshaa-homes-surakshaa-habitat-',last_insert_id()),'','0000-00-00','2001-08-01','http://www.surakshaahomes.com/?cat=3',999,999,'','','HUDA',5,2,4,'',0,0,'2003-11-01','Residential',NULL,0,7,1,28,2,867388,'0000-00-00','Plots',NULL,NULL,NULL,NULL,558,'2014-02-11 15:31:33','2014-11-10 19:28:12',NULL,4.1,'0',4,4.1,0);

-- test resi_project_options
INSERT INTO `resi_project_options` VALUES (0, 502424,'3BHK+3T','Apartment','Actual',3,3,0,0,0,0,1205,0,0,0,0,NULL,0,0,'',0,506,'2013-11-13 23:37:44','2013-11-13 18:07:44');
...
insert into notification.event_type values(10, 'property_url_generation', 'SUPPRESS', 0, 1, 0, NULL, NULL);
