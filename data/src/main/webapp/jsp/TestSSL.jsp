...
<SCRIPT type="text/javascript">
	var merchantURLPart = "http://localhost:8080/citruspay-ssl-page/cleartrip";
	var vanityURLPart="";
	var reqObj = null;
	function generateHMAC() {
		...
		reqObj.open("POST", "hmac_signature.jsp?"+param, false);
		reqObj.send(null);
	}
	function process() {
...
<div id="page-header">
	...
	<ul class="form-wrapper add-merchant clearfix">
		...
		<li class="clearfix"> <label width="125px;">Transaction Number:</label> <input type="text" id="merchantTxnId" class="text" name="merchantTxnId" value="" /> </li>
	
		<li class="clearfix"> <label width="125px;">Order Amount:</label>
			 <input type="text" id="orderAmount" class="text" name="orderAmount" value="" /> </li>
		...
		<!-- Dynamic pricing section starts here 
		Uncomment the below dynamic pricing section if dynamic pricing to be sent from merchant site
		pass the values as 'Yes' or 'No'. By default it is 'Yes'
		-->
		<li class="clearfix"> <label width="125px;">Dynamic pricing:</label>
			<input type="text" class="text" name="dpFlag" value="" />
		</li>
		...
		<!--
		If merchant needs to hardcode template id 
		
		<input type="hidden" id="secSignature" name="secSignature" value="MTT001" />
		...
		<!-- Net banking section START
		 ...
		 <input type="hidden" name="issuerCode" value="CID001"/>  
		...
		<input
			...
			value="http://localhost:8080/Kit-Test/jsp/TestMotoResponse.jsp" />
		<input
			type="hidden" name="notifyUrl"
			value="https://localhost:8080/Kit-Test/jsp/TestNotifyResponse.jsp" />
