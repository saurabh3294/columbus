				...
				<div>
					...
					<ul class="tbl-wrapper clearfix" id="chkoutPageUserPramList">
						<li class="tbl-header">
							...
							<div class="tbl-col col-7">Original Amount</div>
							<div class="tbl-col col-8">Adjusted Amount</div>
							<div class="tbl-col col-9">Rule Name</div>
							<div class="tbl-col col-10">RuleType</div>
						...
						<li>
							...
							<div class="tbl-col col-7">
								<%
									out.println(request.getParameter("originalAmount") == null ? "" : request
											.getParameter("originalAmount"));
								%>
							</div>
							
							<div class="tbl-col col-8">
								<%
									out.println(request.getParameter("adjustedAmount") == null ? "" : request
											.getParameter("adjustedAmount"));
								%>
							</div>
							
							<div class="tbl-col col-8">
								<%
									out.println(request.getParameter("dpRuleName") == null ? "" : request
											.getParameter("dpRuleName"));
								%>
							</div>
							
							<div class="tbl-col col-8">
								<%
									out.println(request.getParameter("dpRuleType") == null ? "" : request
											.getParameter("dpRuleType"));
								%>
							</div>
							
							<div class="tbl-col col-8">
								<%
									out.println(request.getParameter("transactionAmount") == null ? "" : request
