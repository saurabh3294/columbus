 ...
 * Circle.java
 * 
 * The Circle class represents a circle in the two-dimensional Cartesian
 * corrdinate space.
 * 
 * Created: Aug 15 2006
 * 
...
public class Circle {
    ...
    public Circle(Point p1, Point p2, Point p3) {
        try {
            double x = (p3.getX() * p3.getX()
                    * (p1.getY() - p2.getY())
                    + (p1.getX() * p1.getX() + (p1.getY() - p2.getY()) * (p1.getY() - p3.getY()))
                    * (p2.getY() - p3.getY()) + p2.getX() * p2.getX() * (-p1.getY() + p3.getY())) / (2 * (p3.getX() * (p1
                    .getY() - p2.getY()) + p1.getX() * (p2.getY() - p3.getY()) + p2.getX() * (-p1.getY() + p3.getY())));
