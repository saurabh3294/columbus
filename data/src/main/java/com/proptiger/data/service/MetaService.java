 ...
 * ResourceMetaInfo, that meta information includes resource name and field meta
 * data of that class annotated with FieldMetaInfo
 * 
...
public class MetaService {
        ...
        while (itr.hasNext()) {
            ...
            for (Field field : fields) {
                ...
                if (fieldAnnotation != null) {
                    DataType dataType = (DataType) AnnotationUtils.getAnnotationAttributes(fieldAnnotation).get(
                            DATA_TYPE);
                    ...
                    fieldMetaData.setDescription((String) AnnotationUtils.getAnnotationAttributes(fieldAnnotation).get(
                            DESCRIPTION));
                    fieldMetaData.setDisplayName((String) AnnotationUtils.getAnnotationAttributes(fieldAnnotation).get(
                            DISPLAY_NAME));
                    fieldMetaData.setEditable((Boolean) AnnotationUtils.getAnnotationAttributes(fieldAnnotation).get(
                            EDITABLE));
    ...
    /**
     * Return ResourceModelMeta for a particular resource if name passed
     * otherwise returns meta information of all resources
     * 
     * @param resourceName
