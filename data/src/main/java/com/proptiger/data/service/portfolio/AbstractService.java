...
public abstract class AbstractService {
    ...
    protected <T extends Resource & NamedResource> void preProcessCreate(T resource) {
        ...
        // setting id to null as it will be auto generated, so ignoring its
        // value if passed in request body
        resource.setId(null);
    }

    /**
     * This method is a place holder for post process work after creating a
     * resource
     * 
     * @param resource
     */
    ...
    /**
     * Validating id part of resource, that should not be null, this is pre
     * check before update
     * 
     * @param resource
     */
