...
public class LeadOfferController extends BaseController {
    ...
    @ResponseBody
    public APIResponse offerListing(@RequestBody List<Integer> listingIds, @PathVariable int leadOfferId, @ModelAttribute(Constants.LOGIN_INFO_OBJECT_NAME) ActiveUser activeUser) {
    ...
    @ResponseBody
    public APIResponse getOfferedListings(@PathVariable int leadOfferId, @ModelAttribute FIQLSelector selector, @ModelAttribute(Constants.LOGIN_INFO_OBJECT_NAME) ActiveUser activeUser) {
        PaginatedResponse<List<Listing>> offeredListings = leadOfferService.getOfferedListings(leadOfferId);
        return new APIResponse(super.filterFieldsFromSelector(offeredListings.getResults(), selector), offeredListings.getTotalCount());
    }
    ...
    @ResponseBody
    public APIResponse update(@RequestBody LeadOffer leadOffer, @PathVariable int leadOfferId, @ModelAttribute(Constants.LOGIN_INFO_OBJECT_NAME) ActiveUser activeUser) {
