...
public class GraphController {
    ...
    @ResponseBody
    public Map<String, Map<String, Map<Integer, Integer>>> getProjectDistrubtionOnStatus(
    ...
    @ResponseBody
    public Map<String, Map<String, Double>> getEnquiryDistributionOnLocality(
            @RequestParam(value = "params") String params) {
    ...
    @ResponseBody
    public APIResponse getPropertyPriceTrends(@RequestParam String params) {
        Type type = new TypeToken<Map<String, Object>>() {}.getType();
        Map<String, Object> paramObject = gson.fromJson(params, type);
         ...
         * 
         * Object priceTrends =
         * graphService.getPropertyPriceTrends(paramObject); Object
         * priceTrendsComparisionLocalities =
         * graphService.getPriceTrendComparisionLocalities(paramObject);
         * 
         * response.put("price_trends", priceTrends);
         * response.put("price_trends_comparison_localites",
         * priceTrendsComparisionLocalities);
         */

        return new APIResponse(graphService.getPriceTrendsGraphs(paramObject));
    }
}
