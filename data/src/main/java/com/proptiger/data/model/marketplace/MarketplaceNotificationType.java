...
public class MarketplaceNotificationType extends BaseModel {
    ...
    private static final Comparator<MarketplaceNotificationType> notificationTypeReverseComparator = new Comparator<MarketplaceNotificationType>() {
        @Override
        public int compare(MarketplaceNotificationType o1, MarketplaceNotificationType o2) {
            int result;
    ...
    public static Comparator<MarketplaceNotificationType> getNotificationtypereversecomparator() {
