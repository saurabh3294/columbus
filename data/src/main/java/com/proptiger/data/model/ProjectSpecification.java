...
public class ProjectSpecification extends BaseModel {
    ...
    private static enum SpecificationTypes {
        FLOORING_MASTER_BEDROOM(new String[] { "flooring", "MasterBedroom" }), FLOORING_OTHER_BEDROOM(new String[] {
                "flooring",
                "OtherBedroom" }), FLOORING_LIVING_DINING(new String[] { "flooring", "LivingDining" }), FLOORING_KITCHEN(
                ...
                new String[] { "walls", "Exterior" }), WALLS_KITCHEN(new String[] { "walls", "Kitchen" }), DOORS_MAIN(
                new String[] { "doors", "Main" }), DOORS_INTERNAL(new String[] { "doors", "Internal" }), WINDOWS(
                new String[] { "windows" }), ELECTRICAL_FITTINGS(new String[] { "electricalFittings" }), FITTINGS_AND_FIXTURES_TOILETS(
                new String[] { "fittingsAndFixtures", "Toilets" }), FITTINGS_AND_FIXTURES_KITCHEN(new String[] {
                "fittingsAndFixtures",
                "Kitchen" }), OTHERS(new String[] { "others" }), WALLS_TOILETS(new String[] { "walls", "Toilets" });
    ...
    private Object addSpecificationSplitsInMap(Map<String, Object> map, String[] speciStrings, int index, Object Value) {
        ...
        map.put(
                speciStrings[index],
                addSpecificationSplitsInMap(
                        (Map<String, Object>) map.get(speciStrings[index]),
                        speciStrings,
                        index + 1,
                        Value));
