...
public class NotificationGeneratedService {
    ...
    public void updateNotificationGeneratedStatusOnOldStatus(Map<NotificationStatus, List<NotificationGenerated>> map, Map<Integer, List<NotificationGenerated>> allNotificationGenMap) {
        if (map == null) {
            return;
        }
        ...
        /**
         * Getting All the Distinct NotificationGenerated By their Notification Message Id.
         */
        for (Map.Entry<NotificationStatus, List<NotificationGenerated>> entry : map.entrySet()) {
            for (NotificationGenerated nGenerated : entry.getValue()) {
                // Getting all the Notification Generated for a Notification Message Id.
                allNGenerateds = allNotificationGenMap.get(nGenerated.getNotificationMessage().getId());
                // Removing the first one as it was already present in the distinct Notification Generated.
                allNGenerateds.remove(0);
                /**
                 * Iterating on rest of the notification Generated Group by Notification Message Id.
                 * Replacing the rest Notification Generated payload and status with distinct Notification Generated. 
                 */
                ...
                // Updating the Distinct Notification Generated with their new status.
                notificationGeneratedDao.updateByNotificationStatusOnOldNotificationStatus(
                        nGenerated.getId(),
    ...
    public NotificationGenerated createNotificationGenerated(
        ...
        Number objectId = (Number)notificationMessage.getNotificationMessagePayload().getNotificationTypePayload().getPrimaryKeyValue();
    ...
    public Map<Integer, Map<Integer, List<NotificationGenerated>>> groupNotificationByMessageId(List<NotificationGenerated> nGenerateds, List<NotificationGenerated> distinctNotificationGenerated){
