...
public class NotificationPrimaryKeyProcessor implements NotificationProcessor {
    ...
    public void processInterMerging(
        ...
        for (NotificationByKeyDto notificationByKeyDto : childNotification) {
            merging(notificationByKeyDto, NotificationStatus.InterKeyMerged, notificationMessage);
        }
    }
    ...
    public void processIntraMerging(NotificationByKeyDto notificationByKey) {
        ...
        merging(notificationByKey, NotificationStatus.IntraKeyMerged, lastMessage);
    ...
    protected void merging(
        ...
        List<NotificationMessage> nMessages = notificationByKey.getNotificationMessages();
        List<NotificationGenerated> nGenerateds = notificationByKey.getNotificationGenerateds();
        List<NotificationMessagePayload> mergePayload = parentMessage.getNotificationMessagePayload().getNotificationMessagePayloads();
