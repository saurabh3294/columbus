...
public final class PropertyKeys {
    ...
    public static final String ENABLE_REQUEST_VALIDATION                     = "security.enable.request.validation";
    public static final String ENABLE_REQ_VALIDATION_WARNING                 = "security.enable.request.validation.warning";
    public static final String ENABLE_CRAWL_PREVENTION                        = "security.enable.crawl.prevention";
    ...
    public static final String MARKETPLACE_CALL_DUE_NOTIFICATION_DURATION    = "marketplace.call.due.notification.duration";
    public static final String MARKETPLACE_MAX_BROKER_COUNT_FOR_CLAIM        = "marketplace.max.broker.count.for.claim";

    public static final String MARKETPLACE_TASK_DUE_NOTIFICATION_TIME1       = "marketplace.task.due.notification.time1";
    ...
    public static final String MAIL_OTP_BCC = "mail.otp.bcc";
}
