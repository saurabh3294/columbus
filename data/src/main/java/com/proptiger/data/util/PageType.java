...
public enum PageType {
    ...
    CITY_URLS("^([\\w]+)(?:(((/(apartments-flats-sale|property-sale|house-sale|villas-sale|sites-plots-sale))|-real-estate)(/[\\d]{1,2}bhk)?(/\\d+-\\d+-lacs)?)|(-real-estate/overview)|/(resale-property|ready-to-move-property|under-construction-property|upcoming-property|upcoming-projects|luxury-projects|low-budget-flats|affordable-flats|new-projects-for-sale|upcoming-flats-for-sale|ready-to-move-flats|resale-apartments|new-apartments-for-sale|all-builders))$", new String[] { "cityName" }),
    ...
    NEWS_URLS("^news(?:/category/([\\w]+)|(?:/category/(?:real-estate|home-loan|real-estate-news|real-estate-tips|interior-decorating-design|home-loans))|/(?:[\\w]+(?:\\-[\\w]+)*))?/?$",new String[] {"cityName"}),
