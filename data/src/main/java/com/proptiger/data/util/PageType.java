...
public enum PageType {
    ...
    LOCALITY_SUBURB_LISTING("^(?:[\\w]+)/(apartments-flats-sale|property-sale|house-sale|villas-sale|sites-plots-sale)-(?:[\\-\\w]+)-(\\d{5,5})(/[\\d]bhk)?(/\\d+-\\d+-lacs)?$", new String[] { "propertyType", "localityId", "bedroomString", "priceString" }), 
    ...
    STATIC_URLS("^(?:all-builders|all-projects|news|contactus|aboutus|nri|vaastu|homeloan|documents|faqs|builderpartner|ourservices|management-team|proptiger-media|privacy-policy|user-agreement|careers|sitemap.php|testimonials|emi|disclaimer|404|server-error|sites-plots-sale|projects-in-india|apartments-in-india|flats-in-india|properties-in-india|new-launch-projects-in-india|ongoing-projects-in-india|completed-projects-in-india|new-projects-for-sale-in-india|upcoming-flats-for-sale-in-india|ready-to-move-flats-in-india|resale-apartments-in-india|new-apartments-for-sale-in-india|((apartments-flats-sale|property-sale|villas-sale)(/[\\d]bhk)?))$", new String[]{}),
