...
public enum PageType {
    ...
    CITY_URLS("^([\\w]+)(?:(((/(apartments-flats-sale|property-sale|house-sale|villas-sale|sites-plots-sale))|-real-estate)(/[\\d]{1,2}bhk)?(/\\d+-\\d+-lacs)?)|(-real-estate-overview|-real-estate/schools|-real-estate/restaurants|-real-estate/banks|-real-estate/atms|-real-estate/hospitals|-real-estate/petrolpumps)|/(resale-property|ready-to-move-property|under-construction-property|upcoming-property|upcoming-projects|luxury-projects|low-budget-flats|affordable-flats|new-projects-for-sale|upcoming-flats-for-sale|ready-to-move-flats|resale-apartments|new-apartments-for-sale|all-builders))$", new String[] { "cityName" }),
    ...
    LOCALITY_SUBURB_OVERVIEW("^(?:[\\-\\w]+)/(?:[\\-\\w]+)-(\\d{5,5})(-overview|/schools|/restaurants|/banks|/atms|/hospitals|/petrolpumps)$", new String[] { "localityId", "appendingString"}), 
    ...
    NEWS_URLS("^news(?:/category/([\\w]+)|(?:/category/(?:real-estate|home-loan|real-estate-news|real-estate-tips|interior-decorating-design|home-loans))|/(?:[\\w]+(?:\\-[\\w]+)*) |/(?:\\?p=(\\d+)))?/?$",new String[] {"cityName"}),
