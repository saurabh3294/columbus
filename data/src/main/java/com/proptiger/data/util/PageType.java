...
public enum PageType {
    ...
    STATIC_URLS("^(all-builders|all-projects|aboutus|nri|vaastu|homeloan|documents|faqs|builderpartner|ourservices|management-team|proptiger-media|privacy-policy|user-agreement|careers.php|sitemap.php|testimonials|emi|disclaimer|404|new-launch-projects-in-india|ongoing-projects-in-india|completed-projects-in-india|new-projects-for-sale-in-india|upcoming-flats-for-sale-in-india|ready-to-move-flats-in-india|resale-apartments-in-india|new-apartments-for-sale-in-india|(apartments-flats-sale/[\\d]bhk))$", new String[]{}),
