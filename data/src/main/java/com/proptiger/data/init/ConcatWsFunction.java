...
/**
 * Implements mysql concat_ws function
 * 
 ...
 * 
 */
public class ConcatWsFunction implements SQLFunction {
    ...
    public String render(Type arg0, List arg1, SessionFactoryImplementor arg2) throws QueryException {
        if (arg1.size() < 2) {
            throw new ProAPIException("ConcatWsFunction should have 2 arguments at min");
        }
        return "concat_ws(" + StringUtils.join(arg1, ",") + ")";
    }
