...
/**
 * This is an implementations of Pageable inteface to provide functionality of limit and offset kind of queries.
 * So instead of using page and page size this class will make queries like limit and offset.
