 ...
 */
@Repository
public interface LocalityReviewDao extends
		PagingAndSortingRepository<LocalityReviewComments, Long> {
	...
	@Query("SELECT NEW com.proptiger.data.model.LocalityReviewComments$LocalityReviewCustomDetail(R.review , R.reviewLabel, U.username, R.commenttime, R.userName)"
	...
	public List<LocalityReviewCustomDetail> getReviewCommentsByLocalityId(
	...
	public List<Integer> getTopReviewLocalitiesOnSuburbOrCity(int locationType,
			int locationId, long minCount, Pageable pageable);
	...
	public LocalityReviewComments getByLocalityIdAndUserId(Integer localityId,
			Integer userId);
}
