...
public interface ImageDao extends ImageCustomDao, JpaRepository<Image, Long> {
    ...
    @Query("SELECT I FROM Image as I JOIN FETCH I.imageTypeObj IT JOIN FETCH IT.objectType O JOIN FETCH IT.mediaType MT WHERE IT.mediaTypeId = 1 and I.originalHash = ?1 AND I.objectId = ?2 AND I.imageTypeObj.objectType.type = ?3 AND I.active = 1")
