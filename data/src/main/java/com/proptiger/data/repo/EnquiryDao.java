...
public interface EnquiryDao extends JpaRepository<Enquiry, Serializable> {
    ...
    @Query("select NEW com.proptiger.core.model.proptiger.Enquiry$EnquiryCustomDetails(E.projectName, E.cityName, P.projectUrl, E.createdDate, B.name) " + " from  Enquiry E left join E.project P "
